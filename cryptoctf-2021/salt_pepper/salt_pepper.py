...
assert md5(salt).hexdigest()	== '5f72c4360a2287bc269e0ccba6fc24ba' # 1 full state, 3 bytes taken
assert sha1(pepper).hexdigest()	== '3e0d000a4b0bd712999d730bc331f400221008e0' # we control last byte of state. 0x80?
