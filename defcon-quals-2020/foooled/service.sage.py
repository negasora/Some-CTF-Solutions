...
# This file was *autogenerated* from the file service.sage
from sage.all_cmdline import *   # import sage library

_sage_const_8 = Integer(8); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_26549257466517037015103216807969921585440836216352333717701970845542 = Integer(26549257466517037015103216807969921585440836216352333717701970845542)#!/usr/bin/env sage
...
def launch_attack(P, Q, p):
    E = P.curve()
    Eqp = EllipticCurve(Qp(p, _sage_const_8 ), [ZZ(t) for t in E.a_invariants()])
...
def curve_agreement(threshold):
    ...
    try:
        ...
        if p >= threshold and E.order() == p:
            ...
            print("Deal! Here is the generator: (%s, %s)" % (P.xy()[_sage_const_0 ], P.xy()[_sage_const_1 ]))
            return E, P
        else:
            raise ValueError
    except Exception:
...
def main():
    banner()
    threshold = _sage_const_26549257466517037015103216807969921585440836216352333717701970845542  #set_threshold()
