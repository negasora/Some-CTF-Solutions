...
ptxt = b'Blue is greener than purple for sure!'
ctxt = binascii.unhexlify('fe9d88f3d675d0c90d95468212b79e929efffcf281d04f0cfa6d07704118943da2af36b9f8')

flag_ctxt = binascii.unhexlify('de9289f08d6bcb90359f4dd70e8d95829fc8ffaf90ce5d21f96e3d635f148a68e4eb32efa4')

key = xnor_bytes(ptxt, ctxt)

print(key)
print(xnor_bytes(flag_ctxt, key))
