...
alphabet = "bctf{ABCDSqGHlJKLMONPQRE5mVWyYFiXedZa862z9ghxjkIU4w3ors+uvp01nT}"

assert len(alphabet) == len(set(alphabet)), sorted(alphabet)
...
starting_string = "1"#input("String to encode? ")
